...
class PermafrostModel_2D_20dhmin_hv_1500m(EarthModel):
    def __init__(self):
        super().__init__()
    ...
    def build_stratigraphy(self):
        ...
        vp = Property("vp", vmin=3700 - 700, vmax=3700+300, texture=200)
        ...
        permafrost = Sequence(lithologies=lithologies_permafrost,
                              ...
                              thick_min=20, thick_max=320,skip_prob=0)
...
class AcquisitionPermafrost_2D_20dhmin_hv_1500m(Acquisition):
    """
...
class DatasetPermafrost_2D_20dhmin_hv_1500m(GeoDataset):
    name = "DatasetPermafrost_2D_20dhmin_hv_1500m"
    ...
    def set_dataset(self):
        ...
        model = PermafrostModel_2D_20dhmin_hv_1500m()
        ...
        acquire = AcquisitionPermafrost_2D_20dhmin_hv_1500m(model=model)
...
if __name__ == "__main__":
    dataset = DatasetPermafrost_2D_20dhmin_hv_1500m()
