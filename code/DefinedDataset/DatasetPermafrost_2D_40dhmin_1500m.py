...
class PermafrostModel_2D_40dhmin_1500m(EarthModel):
    def __init__(self):
        super().__init__()
...
class AcquisitionPermafrost_2D_40dhmin_1500m(Acquisition):
    """
...
class DatasetPermafrost_2D_40dhmin_1500m(GeoDataset):
    name = "DatasetPermafrost_2D_40dhmin_1500m"
    ...
    def set_dataset(self):
        ...
        model = PermafrostModel_2D_40dhmin_1500m()
        ...
        model.layer_dh_min = 40

        acquire = AcquisitionPermafrost_2D_40dhmin_1500m(model=model)
...
if __name__ == "__main__":
    dataset = DatasetPermafrost_2D_40dhmin_1500m()
